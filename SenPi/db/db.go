...
func InitDatabase() error {
	...
	// create data table
	_, err = conn.Exec("CREATE TABLE `" + sqlConfiguration.DataTableName + "` (ID INT PRIMARY KEY AUTO_INCREMENT, Device VARCHAR(255) NULL DEFAULT NULL, Name VARCHAR(255) NULL DEFAULT NULL, Unit VARCHAR(20) NULL DEFAULT NULL, Value FLOAT NULL DEFAULT NULL, StringValue VARCHAR(255) NULL DEFAULT NULL, BoolValue BOOL NULL DEFAULT NULL, DataValue VARCHAR(255) NULL DEFAULT NULL, Sum FLOAT NULL DEFAULT NULL, Time TIMESTAMP NULL DEFAULT NULL, Link VARCHAR(255) NULL DEFAULT NULL);")
	if err != nil {
